...
if(isset($_REQUEST['submit']))
{
	...
	if(($level == "") or ($percentage == "")){
		header("Location:levelcommission.php?error");
		echo "<script>location.href='levelcommission.php?error'</script>";
		exit;
	}
 $insert = $db->insertrec("INSERT INTO mlm_level_commission (level,percentage,date,status) VALUES ('$level','$percentage','$date','0')");

	if($insert)
	 { 
	 header("Location:levelcommission.php?succ"); 
	 ?>
	<script>
	window.location="levelcommission.php?succ";
	</script>	
	<?php
	}
}
			...
			<div class="main-content">
				<div class="breadcrumbs" id="breadcrumbs">
					<ul class="breadcrumb">
						...
						<li>
							<a href="levelcomission.php">Level Commission Setting</a>
					...
					<div class="row-fluid">
						<div class="span12">
							...
							<form class="form-horizontal" name="general"  method="post" action="" onsubmit="return planvalidate();" enctype="multipart/form-data" />
								...
								<div class="control-group">
									<label class="control-label" for="form-field-1">commission (%)<span style="color:#FF0000;">*</span> : </label>
