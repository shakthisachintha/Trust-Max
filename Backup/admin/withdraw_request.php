		...
		<div class="main-container container-fluid">
			...
			<div class="main-content">
				...
				<input type="checkbox" id="chkval[]" name="chkval[]" value="<?php echo $row_req['req_id']; ?>"  />
											...
											<td><?php echo !empty($row_req['reason'])?$row_req['reason']:'Withdraw' ?></td>
											...
											<?php if($row_req['req_rpstatus']=='0') { ?>
												...
												<a class="blue" href="withdraw_request.php?reqreply=<?php echo $row_req['req_id']; ?>" >
													<img src="images/pay.JPG" width="70" height="25"/>
												  </a>
												  <?php } else {?>
											 <span class="green" >
											 Transferred
