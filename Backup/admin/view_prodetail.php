...
$detailid=replace($_REQUEST['detail']);
$query=$db->singlerec("select * from mlm_purchase where randomkey='$detailid'");
			...
			<div class="main-content">
				<div class="breadcrumbs" id="breadcrumbs">
					<ul class="breadcrumb">
						...
						<li>
							<a href="productspurchase.php">Purchase Management</a>
...
<div class="row-fluid">
					     ...
					     <div class="control-group">
							...
							<label class="span12" style="padding:8px; font-size:14px; text-align:right;">
							  
							  <button class="btn btn-success" id="pri" value="<?php echo $detailid; ?>" onclick="prin()"><i class="icon-print bigger-130" title="click to edit"></i> Print</button>
							  <input type="hidden" name="in" id="in" value="<?php echo $detailid; ?>" />
							</label>
...
function prin(){
	var iid=$("#in").val();
	window.location='invoice.php?detail='+iid
