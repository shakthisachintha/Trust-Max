...
//Array For Day
$PS_place=array("","Home header","Home footer","Productlist right","Productlist left","Productdetails right","Productdetails body");

$PS_adds = array('Home header','Home footer','page side medium','page side long');
