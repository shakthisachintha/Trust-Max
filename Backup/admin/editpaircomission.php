...
if(isset($_REQUEST['update'])) {
	...
	$update = $db->insertrec("UPDATE mlm_pair_comission SET pair_from='$pair_from',pair_to='$pair_to',pair_amt='$pair_amt' WHERE id='$plan_id'");
	if($update) {
		header("Location:paircomission.php?editsuccess");
		echo "<script>window.location='paircomission.php?editsuccess';</script>";
	}
}
			...
			<div class="main-content">
				<div class="breadcrumbs" id="breadcrumbs">
					<ul class="breadcrumb">
						...
						<li class="active">Edit Pair Comission</li>
					</ul><!--.breadcrumb-->
...
$user=$db->singlerec("select * from mlm_pair_comission where id='$idd'");
$from=$user['pair_from'];
$to=$user['pair_to'];
$p_amt=$user['pair_amt'];
?>
							<form class="form-horizontal" name="general"  method="post" action="" onsubmit="return planvalidate();" enctype="multipart/form-data" />
								...
								<div class="control-group">
									...
									<div id="to" style="display:block;">
									<div class="span12">
									</div>
										<label class="control-label" for="form-field-1">Pair Comission To<span style="color:#FF0000;">*</span> : </label>
										<div class="controls">
								...
								<div class="control-group">
									<label class="control-label" for="form-field-1">Pair Comission (%)<span style="color:#FF0000;">*</span> : </label>

									<div class="controls">
										<input type="text" name="pair_amt" value="<?php echo $p_amt;?>" id="pair_amt" />
									</div>
								</div>
