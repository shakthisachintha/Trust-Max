	...
	<div class="col-sm-6">
        <div class="forny-form">
			...
			<?php if(isset($_REQUEST['succ'])) { ?>
				<p style="color:#00B04E;">Congratulations !! for becoming member with <strong><?=$website_name;?></strong>.<br/> Please Login with your Email ID/User ID and Password.</p>
			<?php } else if(isset($_REQUEST['pyerr'])) { ?>
				<p style="color:#FF0000;"><b>Your payment has been failed. Try completing the trasaction. You can find the payment link in your email.</b></p>
			<?php } else if(isset($_REQUEST['err'])) { ?>
				<p style="color:#FF0000;"><b>Account Doesn't Exists, Please enter valid username and password.</b></p>
			...
			<?php } else{?>
				<p><b>If you have an account with us, Please log in! If you need any help please contact us via <a style="color:#007bff" href="contact.php">ticket system</a> in your dashboard.</b></p>
			<?php }?>
