...
<!-- Breadcrumb -->
	...
	<main class="page-content">
		 ...
		 <div class="blog-details-area section-padding-xs bg-white">
				...
				$event=$db->get_all("select * from mlm_events where event_status='0' order by event_id desc LIMIT {$startpoint} , {$limit}");
				$nom_rows=$db->numrows("select * from mlm_events where event_status='0'");
							...
							<div class="in-blog ">
								...
								<div class="in-blog-content">
									<div class="in-blog-metatop">
										<span><?=date("d M, Y",strtotime($res['event_date']));?></span>
									...
									?></a></h4>
									<p><?php echo substr(strip_tags($res['event_desc']),0,70);
									if(strlen($res['event_desc'])>70){
											echo "...";
								    }
									?> 
									</p>
