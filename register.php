                        ...
                        <div class="tab-pane fade active show" role="tabpanel" id="register">
                            ...
                            <form class="register-form" method="post" onSubmit="return formvalidation();" action="registerfunc.php">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="password"><b>Password: <span class="required">*</span></b>
                                            </label>
                                            <div class="input-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="sponsorid"><b>Sponsor Id: <span class="required">*</span></b>
                                            </label>
                                            <div class="input-group">
                                            ...
                                            <span style="color:#999999"><b> Ex :
                                                    <?echo $Random['user_profileid'];?> </b></span><br>
                                ...
                                <div class="row">
                                    ...
                                    <?php
                                    $reward_plans = $db->get_all("select * from reward_plans order by points asc");
                                    ?>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label> <b>Reward Plan:</b> <span class="required">*</span></b>
                                            </label><br />
                                            <div class="form-group">
