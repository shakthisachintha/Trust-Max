                    ...
                    <div class="row">
										...
										<div class="panel-body">
											...
											<form name="form1" action="" method="post">
												...
												<tr>
													...
													<td align="center">:</td>
													<td>
														<input class="form-control" type="text" name="user_pancard" id="user_pancard" value="<?php echo $userdetail['user_pancard']; ?>">
													</td>
													</tr>
						...
						<input class="form-control" type="text" name="email" id="email" value="<?php echo $userdetail['user_email']; ?>" required="true">
							...
							<input class="form-control" type="text" name="czipcode" id="czipcode" value="<?php echo $userdetail['user_postalcode']; ?>">
										...
										<td align="center">:</td>
										<td>
							<input class="form-control"  type="text" name="cpaddr1" id="cpaddr1" value="<?php echo $userdetail['user_paddr1']; ?>">
							</td>
							</tr>
							...
							<td align="center">:</td>
							<td>
							<input class="form-control" type="text" name="cpaddr2"  id="cpaddr2" value="<?php echo $userdetail['user_paddr2']; ?>">
							</td>
							</tr>
							...
							<td align="center">:</td>
							<td>
							<select class="form-control"  name="cpcountry" id="cpcountry" onchange="return stateview(this.value);">
									<option value="">--- Choose Country ---</option>
									<?php 
							...
							<td align="center">:</td>
							<td>
							<input class="form-control" type="text" name="cpzipcode" id="cpzipcode" value="<?php echo $userdetail['user_ppostalcode']; ?>">
							</td>
							</tr>
