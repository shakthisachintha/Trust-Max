				...
				<div class="page-content">
					...
					<div class="row-fluid">
						...
						<div class="alert alert-block alert-success">
							 ...
							 <i class="icon-ok green"></i>
								<strong class="green">
									Sub Menu Unblocked Successfully !!!
								</strong>
						  ...
						  ?> 
                           ...
                           <form action="" method="post">
							<div class="row-fluid">
								...
								<span style="float:right; padding-right:5px;"><a href="add_submenu.php?page=menu&upd=1&sid=<?php echo $sid;?>" style="color:#FFFFFF;">+ ADD Sub Menu</a></span>
								...
								<table class="table table-striped table-bordered table-hover" id="sample-table-2">
									...
									$usrr=$db->get_all("select * from main_menu where param='1' and m_param='$sid' order by menu_id desc");
									$i=1;
									...
									?>
										...
										<tr>
											...
											<td><?php echo $name; ?></td>
											 ...
											 <td class="center"><?php echo $msg; ?></td>
											...
											{		
												...
												<a class="blue" href="add_submenu.php?page=menu&upd=2&sid=<?php echo $row_usrr['menu_id'];?>">
								...
								<input type="submit" name="mul_per" id="mul_per" value="Menu Permission" onclick="return muldel();" style="color:#FFFFFF; margin-top:5px;" class="btn btn-small btn-success pull-left" title="click to activate"/>
								
								<input type="submit" name="mul_perm" id="mul_perm" value="Menu UnPermission" onclick="return muldel();" style="color:#FFFFFF; margin-top:5px;" class="btn btn-small btn-success pull-left" title="click to activate"/>
