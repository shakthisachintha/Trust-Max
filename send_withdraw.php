	...
	<div class="container main">
			...
			<div class="col-sm-9">
				<div class="row">
					...
					<div class="col-sm-12">
						...
						<a href="javascript:void(0);" onClick="showpop111();" style="color:#000;" class="btn btn-success">Withdraw Balance</a>
						<? } ?>
						<div class="banner">
									...
									?>
										...
										<tr>
											...
											<td>
												...
												<?php } elseif ($rreqq['req_rpstatus'] == 2) { ?>
													<span class="red">
														Rejected
													</span>
												<?php } elseif ($rreqq['req_rpstatus'] == 1) { ?>
		...
		<div id="light111" class="white_content111">
			<form name="myfor" id="myfor" action="" method="post" enctype="multipart/form-data" onSubmit="return with_validate();">
				...
				<table>
					<tr>
						<td colspan="3" style="border-bottom:1px #CCCCCC solid; color:#006699; font-weight:bold; font-size:14px;">Withdraw Income</td>
					</tr>
					...
					<tr>
						...
						<td> : &nbsp;&nbsp;</td>
						<td>
							<input type="text" name="amount" id="amount" required="true" onKeyPress="return phnumbersonly(this, event)" onBlur="checkamt(this.value);" style="height:25px;" /> <br>
							<span style="color:#999999;">Minimum withdrawal amount <?php echo $gen_minwithdraw . " " . $sitecurrency; ?></span>
					...
					<tr>
						<input type="hidden" name="acc_bal" value="<?php echo $total; ?>" <td colspan="3">
						</td>
					</tr>

				</table>
				<div class="form-actions" style="position: absolute;bottom: 15px;">
					<input type="submit" name="submit" value="SUBMIT" class="btn btn-info" style="font-weight:bold;"> &nbsp; &nbsp; &nbsp;
					<input type="button" name="close" value="CLOSE" class="btn" style="font-weight:bold;" onClick="hidepop111();">
