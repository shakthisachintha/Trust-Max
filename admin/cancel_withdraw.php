...
$msg="<table cellpadding='0' cellspacing='0' border='0' bgcolor='#006699' style='border:solid 10px #006699; width:550px;'>
		<tr bgcolor='#006699' height='25'>
			<td><img src=".$logourl." border='0' width='200' height='60' /></td>
						...
						<td style='padding-left:20px; font-family:Arial; font-size:11px; line-height:18px; text-decoration:none; color:#000000;'>Your Requested amount transferred to your account, please check it.</td>
						</tr>
...
header("location:cancel_withdraw.php?del");

echo "<script>window.location='cancel_withdraw.php?del';</script>";
...
if($result){?> <script>
window.location="cancel_withdraw.php?del";
</script> <?php
}
 }
			...
			<div class="main-content">
				<div class="breadcrumbs" id="breadcrumbs">
					<ul class="breadcrumb">
						...
						<li class="active">Cancel withdraw request list </li>
					</ul><!--.breadcrumb-->
                          ...
                          <form action="" method="post">
							...
							<div class="row-fluid">
								...
								<table class="table table-striped table-bordered table-hover" id="sample-table-2">
									...
									$req=$db->get_all("select * from mlm_withdrawrequsets where req_status=1 order by req_id desc");
									$i=1;
									$num=$db->numrows("select * from mlm_withdrawrequsets where req_status=1 order by req_id desc");
				...
				<input type="checkbox" id="chkval[]" name="chkval[]" value="<?php echo $row_req['req_id']; ?>"  />
                                            ...
                                            <td><?php echo $row_req['req_subject']; ?></td>
											...
											<?php if($row_req['req_rpstatus']=='0') { ?>
											 ...
											 Transferred
												...
												<div class="hidden-phone visible-desktop action-buttons">
													<a class="grey" href="cancel_withdraw.php?delete=<?php echo $row_req['req_id'];?>" onclick="if(confirm('Are you sure to delete this record')) { return true; } else { return false; }">
