...
$detail=$db->singlerec("select * from mlm_register where user_id='$detailid'");
$sponid=$detail['user_sponserid'];
					...
					<div class="span12">
							<!--PAGE CONTENT BEGINS-->
								...
								<div class="control-group">
						            ...
						            <div style="float:left;"><?php echo $details['user_fname'].' '.$details['user_lname']; ?></div>
								...
								<div style="float:left; font-weight:bold; width:150px;" align="right">Placement Position</div>
									...
									<?php echo $detail['user_position'];?></div>
									<div style="clear:both;">&nbsp;</div>
...
<div class="row-fluid">
						...
						<div class="span12">
							...
							<div style="float:left; font-weight:bold; width:150px;" align="right" >Phone</div>
									<div style="float:left; width:20px;" align="center">:</div>
						            <div style="float:left;"><?php echo !empty($detail['user_phone'])?$detail['user_phone']:''; ?></div>
									<div style="clear:both;">&nbsp;</div>
							...
							<div style="float:left; font-weight:bold; width:150px;" align="right" >Bank Account No</div>
									<div style="float:left; width:20px;" align="center">:</div>
						            <div style="float:left;"><?php echo !empty($detail['user_accno'])?$detail['user_accno']:''; ?></div>
									<div style="clear:both;">&nbsp;</div>
								 ...
								 <div class="control-group">
								  ...
								  <div style="float:left; font-weight:bold; width:150px;" align="right" >IFSC</div>
									<div style="float:left; width:20px;" align="center">:</div>
                        ...
                        <div class="control-group">
							...
							<label style="border-bottom:1px #CCCCCC solid; font-weight:bold; color:#FF6600;">Communication Address </label>
							...
							<div style="float:left; font-weight:bold; width:150px;" align="right" >Address 2</div>
									...
									$sqlcon=$db->singlerec("select * from mlm_country where country_status='1' and country_id='$detail[user_country]' order by country_name asc");
									?>
								...
								<div style="float:left; font-weight:bold; width:150px;" align="right" >State</div>
									...
									$sqlstate=$db->singlerec("select * from mlm_state where state_status='0' and state_id='$detail[user_state]' order by state_name asc");
									?>
								...
								<div style="float:left; font-weight:bold; width:150px;" align="right" >City</div>
									...
									$sqlcity=$db->singlerec("select * from mlm_city where city_status='0' and city_id='$detail[user_city]' order by city_name asc");
									?>
									...
									<div style="clear:both;">&nbsp;</div>
								      ...
								      <div class="control-group">
		<label style="border-bottom:1px #CCCCCC solid; font-weight:bold; color:#FF6600;">Permanent Address &nbsp
		</label>
								</div>
							...
							<div class="control-group">
								...
								<div style="float:left; font-weight:bold; width:150px;" align="right" >Address 2</div>
									...
									$sqlcon=$db->singlerec("select * from mlm_country where country_status='1' and country_id='$detail[user_pcountry]' order by country_name asc");
									?>
									<?php echo $sqlcon['country_name']; ?>
								...
								<div class="control-group">
									...
									$sqlstate=$db->singlerec("select * from mlm_state where state_status='0' and state_id='$detail[user_pstate]' order by state_name asc");
									?>
									<?php echo $sqlstate['state_name']; ?></div>
									<div style="clear:both;">&nbsp;</div>
								</div>
								...
								<div class="control-group">
									...
									$sqlcity=$db->singlerec("select * from mlm_city where city_status='0' and city_id='$detail[user_pcity]' order by city_name asc");
									?>
									<?php echo $sqlcity['city_name']; ?></div>
									<div style="clear:both;">&nbsp;</div>
								</div>
					     ...
					     <div class="control-group">
						  ...
						  <div class="span12">
							<!--PAGE CONTENT BEGINS-->
								...
								<div style="float:left; font-weight:bold; width:150px;" align="right" >Phone</div>
									<div style="float:left; width:20px;" align="center">:</div>
						            <div style="float:left;"><?php echo !empty($detail['user_nphone'])?$detail['user_nphone']:''; ?></div>
									<div style="clear:both;">&nbsp;</div>
							...
							<div class="control-group">
									...
									$sqlcon=$db->singlerec("select * from mlm_country where country_status='1' and country_id='$detail[user_ncountry]' order by country_name asc");
									?>
									<?php echo $sqlcon['country_name']; ?>
								...
								<div class="control-group">
									...
									$sqlstate=$db->singlerec("select * from mlm_state where state_status='0' and state_id='$detail[user_nstate]' order by state_name asc");
									?>
									<?php echo $sqlstate['state_name']; ?></div>
									<div style="clear:both;">&nbsp;</div>
								</div>
								...
								<div class="control-group">
									...
									$sqlcity=$db->singlerec("select * from mlm_city where city_status='0' and city_id='$detail[user_ncity]' order by city_name asc");
									?>
									<?php echo $sqlcity['city_name']; ?></div>
									<div style="clear:both;">&nbsp;</div>
								</div>
								...
								<a href="user_edit.php?edit=<?php echo $detailid; ?>" class="btn btn-info" style="font-weight:bold;">EDIT</a>
