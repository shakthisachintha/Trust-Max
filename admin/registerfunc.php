...
{ 
	...
	$insert = $db->insertrec("INSERT INTO mlm_register (user_profileid, policy, ammount, user_fname, user_lname, user_email, user_password, user_sponsername,user_sponserid, user_placementid, user_position, user_pancard, user_date, user_ip, user_status) VALUES ('$profileid','$policy','$amount','$fName','$lName','$userEmail','$password', '$sponsorname', '$sponsorid', '$placementid', '$user_position', '$pancardnum', '$cur_date', '$ip_addr', '0')");
