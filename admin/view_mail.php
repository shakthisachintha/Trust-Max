...
$details=stripslashes($_REQUEST['detail']);

$fwdval=$db->singlerec("select * from mlm_outbox where outbox_id='$details'");

if(isset($_REQUEST['usrviewed']))
{
$db->insertrec("update mlm_outbox set outbox_readstatus='1' where outbox_id='$details'");
}
 ?>
					...
					<div class="row-fluid">
						<div class="span12">
							...
							<div class="control-group">
									...
									<div class="controls">
										<?php echo $fwdval['outbox_subject']; ?>
									...
									<div class="controls">
										<?php echo $fwdval['outbox_message']; ?>
									</div>
								</div>	
