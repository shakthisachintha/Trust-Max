...
$subject="Feedback reply details from ".$website_name;
...
$cou=$db->insertrec("update mlm_feedback set fb_replystatus='1' where fb_id='$id'");
...
$det=$db->insertrec("delete from mlm_feedback where fb_id='$id'");
                          ...
                          <form action="" method="post">
							...
							<div class="row-fluid">
								...
								<table class="table table-striped table-bordered table-hover" id="sample-table-2">
									...
									$fdb=$db->get_all("select * from mlm_feedback order by fb_id desc");
									$i=1;
									$num=$db->numrows("select * from mlm_feedback");
										...
										<tr>
											...
											<?php if($row_fdb['fb_replystatus']=='0') { ?>
											 ...
											 Replied
												...
												<div class="hidden-phone visible-desktop action-buttons">
												<span>	
													<a href="viewfeed.php?detail=<?php echo $row_fdb['fb_id'];?>" >
