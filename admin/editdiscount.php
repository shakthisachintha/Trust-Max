...
if(isset($_REQUEST['update'])) {
	...
	$pair_from = addslashes($_REQUEST['dis_from']);
	$pair_to = addslashes($_REQUEST['dis_to']);
	$pair_amt = addslashes($_REQUEST['dis_amt']);
	$update = $db->insertrec("UPDATE mlm_discount_plan SET dis_from='$pair_from',dis_to='$pair_to',dis_amt='$pair_amt' WHERE id='$plan_id'");
	if($update) {
			header("Location:discountplan.php?editsuccess");
		echo "<script>window.location='discountplan.php?editsuccess';</script>";
	}
}
			...
			<div class="main-content">
				<div class="breadcrumbs" id="breadcrumbs">
					<ul class="breadcrumb">
						...
						<li>
							<a href="discountplan.php">Discount Plan</a>

							<span class="divider">
								<i class="icon-angle-right arrow-icon"></i>
							</span>
						</li>
						<li class="active">Edit Discount Plan</li>
					</ul><!--.breadcrumb-->
...
$user=$db->singlerec("select * from mlm_discount_plan where id='$idd'");
$from=$user['dis_from'];
$to=$user['dis_to'];
$p_amt=$user['dis_amt'];
?>
							<form class="form-horizontal" name="general"  method="post" action="" onsubmit="return planvalidate();" enctype="multipart/form-data" />
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" name="dis_amt" value="<?php echo $p_amt;?>" id="dis_amt" />
									</div>
								</div>
