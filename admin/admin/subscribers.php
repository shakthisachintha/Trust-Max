...
$subject_1=addslashes($_REQUEST['subject']);
$message=addslashes($_REQUEST['message']);

$subject="Subscriber reply details from ".$website_name;
...
$msg="<table cellpadding='0' cellspacing='0' border='0' bgcolor='#006699' style='border:solid 10px #006699; width:550px;'>
		<tr bgcolor='#006699' height='25'>
			<td><img src=".$logourl." border='0' width='200' height='60' /></td>
						...
						<td style='padding-left:20px; font-family:Arial; font-size:11px; line-height:18px; text-decoration:none; color:#000000;'>Subject : $subject_1</td>
						</tr>
						<tr bgcolor='#FFFFFF' height='35'>
...
$cou=$db->insertrec("update mlm_subscriber set status='1' where id='$id'");

if($cou)
{

header("location:subscribers.php?upsucc");

echo "<script>window.location='subscribers.php?upsucc';</script>";
...
$det=$db->insertrec("delete from mlm_subscriber where id='$id'");

if($det)
{

header("location:subscribers.php?del");

echo "<script>window.location='subscribers.php?del';</script>";
...
$sql = "delete from mlm_subscribers where id='$del_id'";
$result = $db->insertrec($sql);

}

if($result){?> <script>
window.location="subscribers.php?del";
</script> <?php
}
 }
			...
			<div class="main-content">
						  ...
						  ?> 
						   ...
						   <div class="alert alert-block alert-error">
							 ...
							 <i class="icon-off red"></i>
								<strong class="red">
									Subscriber blocked Successfully !!!
								</strong>
                          ...
                          <form action="" method="post">
							...
							<div class="row-fluid">
								...
								<table class="table table-striped table-bordered table-hover" id="sample-table-2">
									...
									$fdb=$db->get_all("select * from mlm_subscriber order by id desc");
									$i=1;
									//$num=$db->num_rows("select * from mlm_subscriber");
									
									foreach($fdb as $i=>$row_fdb)
									{
				...
				<input type="checkbox" id="chkval[]" name="chkval[]" value="<?php echo $row_fdb['id']; ?>"  />
											...
											<?php if($row_fdb['status']=='0') { ?>
												...
												<a class="blue" href="#" onclick="showpop1('<?php echo $row_fdb['id']; ?>','<?php echo $row_fdb['email']; ?>');">
											 ...
											 Replied
												...
												<div class="hidden-phone visible-desktop action-buttons">
													...
													<a class="grey" href="subscribers.php?delete=<?php echo $row_fdb['id'];?>" onclick="if(confirm('Are you sure to delete this record')) { return true; } else { return false; }">
...
<![endif]-->
    ...
    <div id="light1"  class="white_content">
								...
								<table>
								<tr>
								<td colspan="3" style="border-bottom:1px #CCCCCC solid; color:#006699; font-weight:bold; font-size:14px;">Reply Subscriber</td>
								</tr>
