...
$act=$db->insertrec("update mlm_membership set status='0' where id='$id'");
...
$act=$db->insertrec("update mlm_membership set status='1' where id='$id'");
...
$det=$db->insertrec("delete from mlm_membership where id='$id'");
...
$sql = "update mlm_membership set status='1' where id='$act_id'";
$result = $db->insertrec($sql);
}
...
$sql = "update mlm_membership set status='0' where id='$inact_id'";
$result = $db->insertrec($sql);
}
								...
								<table class="table table-striped table-bordered table-hover" id="sample-table-2">
									<thead>
										<tr>
											...
											<th width="41">Amount</th>
                                              <th width="15" >Valid For</th>
											  <th width="41">Capping Amount</th>
									...
									<?php
									$plan=$db->get_all("select * from mlm_membership order by act_amount ASC");
									$i=1;
									$num=$db->numrows("select * from mlm_membership");
									...
									?>
										<tr>
											...
											<td><?php echo $row_plans['act_amount']." ".$sitecurrency; ?></td>
                                            <td><?php echo $row_plans['days']." days"; ?></td>
											<td><?php echo $row_plans['capping_amt']." ".$sitecurrency; ?></td>
