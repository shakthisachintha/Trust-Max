...
?>
<script>
window.location="payout.php?paysucc";
</script>
<?php
}
...
?>
<script>
window.location="payout.php?del";
</script>
               ...
               <!--/row-->
                  ...
                  <div class="row-fluid">
                     <div class="table-header">
                        Payout Management
						<span style="float:right; padding-right:10px;"><a href="export_payout.php?user=<?php echo $user; ?>&fromdate=<?php echo $from_date; ?>&todate=<?php echo $to_date; ?>&sindate=<?php echo $from_date; ?>&stodate=<?php echo $to_date; ?>&today=<?php echo $today; ?>&lastten=<?php echo $lastten; ?>&monthly=<?php echo $monthly; ?>&reason=referral&search=search" style="text-decoration:none; color:#fff;">Export Report</a></span>
                     </div><br/>
	...
	?>	
		<div class="date">					
			<form name="frmSearch" action="<?php $_SERVER['PHP_SELF']?>" method="POST" enctype="multipart/form-data">
				...
				<input type="submit" class="button" name="submit" value="Search">
                     ...
                     <table class="table table-striped table-bordered table-hover" id="sample-table-2">
                        ...
                        <tbody>
							...
							$que="select * from mlm_payout where amount!='' and reason='Referal Bonus' $search";
               ...
               <?php
				$uid=$user;
				$search="where reason='Referal Bonus'";
				if($uid!=""){
					$em=stripslashes($user);
...
<i class="icon-double-angle-up icon-only bigger-110"></i>
		...
		<script type="text/javascript">
			$(function() {
				...
				"aoColumns": [
			      { "bSortable": false },
			     { "bSortable": true }, { "bSortable": true }, { "bSortable": true },{ "bSortable": true }, { "bSortable": true }, { "bSortable": true },{ "bSortable": false },{ "bSortable": false }
				] } );
