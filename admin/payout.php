...
$puram_sum_f=$db->extract_single("select sum(pay_amount) from mlm_purchase where pay_user='$_SESSION[userid]' AND pay_payment = 2");
			...
			<div class="row" style="margin-top:30px;">
				...
				<div class="col-sm-9">
                    <div class="row">
						...
						<h4 class="navbar-inner" style="color:black; line-height:40px; margin-top: -20px; margin-bottom: 7px;">Referral Payout</h4>
						...
						<tr>
							...
							<td width="25%"><strong>Profileid</strong></td>
						...
						$qry1=$db->get_all("select * from mlm_payout where user_id='$_SESSION[profileid]' and reason='Referal Bonus' order by id desc");	
						$count = $db->numrows("select * from mlm_payout where user_id='$_SESSION[profileid]' and reason='Referal Bonus'");
						$i=1;
						foreach($qry1 as $qry){
						$bt=$qry['bonus_type'];
						if($bt==0){
