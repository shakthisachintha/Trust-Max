...
if($del)
{
header("location:unread.php?del");
echo "<script>window.location='unread.php?del';</script>";
}
}
...
window.location="unread.php?del";
			...
			<div class="main-content">
				<div class="breadcrumbs" id="breadcrumbs">
					<ul class="breadcrumb">
						...
						<li class="active">UNREAD MAILS </li>
					</ul><!--.breadcrumb-->
					<!--#nav-search-->
				</div>
                          ...
                          <form action="" method="post">		  
							...
							<div class="row-fluid">
								...
								<table class="table table-striped table-bordered table-hover" id="sample-table-2">
									...
									$inbdb=$db->get_all("select * from mlm_outbox where (outbox_toprofileid='Admin' and outbox_fromstatus='0') and outbox_readstatus='0' order by outbox_id desc");
									$i=1;
									$num=$db->numrows("select * from mlm_outbox where (outbox_toprofileid='Admin' and outbox_fromstatus='0') and outbox_readstatus='0' order by outbox_id desc");
