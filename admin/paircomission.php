...
$act=$db->insertrec("update mlm_pair_comission set status='0' where id='$id'");

if($act)
{
header("location:paircomission.php?inactsucc");
echo "<script>window.location='paircomission.php?inactsucc';</script>";
}
}
...
$act=$db->insertrec("update mlm_pair_comission set status='1' where id='$id'");

if($act)
{

header("location:paircomission.php?actsucc");

echo "<script>window.location='paircomission.php?actsucc';</script>";
...
$det=$db->insertrec("delete from mlm_pair_comission where id='$id'");

if($det)
{

header("location:paircomission.php?del");

echo "<script>window.location='paircomission.php?del';</script>";
...
$sql = "delete from mlm_pair_comission where id='$del_id'";
$result = $db->insertrec($sql);
}

if($result){?> <script>
window.location="paircomission.php?del";
</script> <?php
}
 }
...
$sql = "update mlm_pair_comission set status='1' where id='$act_id'";
$result = $db->insertrec($sql);
}

if($result){?> <script>
window.location="paircomission.php?actsucc";
</script> <?php
}
 }
...
$sql = "update mlm_pair_comission set status='0' where id='$inact_id'";
$result = $db->insertrec($sql);
}

if($result){?> <script>
window.location="paircomission.php?inactsucc";
</script> <?php
}
 }
?>
			...
			<div class="main-content">
				<div class="breadcrumbs" id="breadcrumbs">
					<ul class="breadcrumb">
						...
						<li class="active">Pair Comission Plan </li>
					</ul><!--.breadcrumb-->
				...
				<div class="page-content">
					...
					<div class="row-fluid">
						...
						<?php    }
						  ...
						  ?> 
						   ...
						   <div class="alert alert-block alert-success">
							 ...
							 <i class="icon-ok green"></i>
								<strong class="green">
									Pair Comission Plan Added Successfully !!!
								</strong>
						  ...
						  ?> 
						   ...
						   <div class="alert alert-block alert-success">
							 ...
							 <i class="icon-ok green"></i>
								<strong class="green">
									Pair Comission Plan Updated Successfully !!!
								</strong>
						  ...
						  ?> 
						   ...
						   <div class="alert alert-block alert-error">
							 ...
							 <i class="icon-trash red"></i>
								<strong class="red">
									Pair Comission Plan Deleted Successfully !!!
								</strong>
						...
						<div class="alert alert-block alert-success">
							 ...
							 <i class="icon-ok green"></i>
								<strong class="green">
									Pair Comission Plan Unblocked Successfully !!!
								</strong>
						  ...
						  ?> 
						   ...
						   <div class="alert alert-block alert-error">
							 ...
							 <i class="icon-off red"></i>
								<strong class="red">
									Pair Comission Plan blocked Successfully !!!
								</strong>
                           ...
                           <form action="" method="post">
							<div class="row-fluid">
								...
								Pair Comission Plan Management
								
								<span style="float:right; padding-right:5px;"><a href="addcomission.php" style="color:#FFFFFF;">+ ADD Pair Comission Plan</a></span>
								...
								<table class="table table-striped table-bordered table-hover" id="sample-table-2">
									...
									<?php
									$plan=$db->get_all("select * from mlm_pair_comission order by id ASC");
									$i=1;
									$num=$db->numrows("select * from mlm_pair_comission");
									...
									?>
										<tr>
											...
											<td><?php echo $i; ?></td>
											<td><?php echo $row_plans['pair_from']; ?></td>
                                            <td><?php echo $row_plans['pair_to']; ?></td>
											<td><?php echo $row_plans['pair_amt']; ?></td>
											<td class="td-actions" align="center">
												<div class="hidden-phone visible-desktop action-buttons">
													<?php if($row_plans['status']=='0') { ?>
													
													<a class="red" href="paircomission.php?inact=<?php echo $row_plans['id'];?>" onclick="if(confirm('Are you sure to activate this record')) { return true; } else { return false; }">
														<i class="icon-certificate bigger-130" title="click to activate"></i>
													</a>
													
													<?php } if($row_plans['status']=='1') { ?>
												
												<a class="green" href="paircomission.php?act=<?php echo $row_plans['id']; ?>" onclick="if(confirm('Are you sure to deactivate this record')) { return true; } else { return false; }">
												...
												<a class="blue" href="editpaircomission.php?memid=<?php echo $row_plans['id']; ?>">
                                      ...
                                      <?php if($demomode=='true'){?>
									   <a class="grey" onclick="demo()">
										...
										<?}else{?>
													<a class="grey" href="paircomission.php?delete=<?php echo $row_plans['id'];?>" onclick="if(confirm('Are you sure to delete this record')) { return true; } else { return false; }">
														<i class="icon-trash bigger-130" title="click to delete"></i>
													</a> 
													<?}?>
