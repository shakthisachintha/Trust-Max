...
$del=$db->singlerec("update mlm_outbox set outbox_fromstatus='1' where outbox_id='$delid'");
...
header("location:read.php?del");

echo "<script>window.location='read.php?del';</script>";
						   ...
						   <div class="alert alert-block alert-success">
							 ...
							 <i class="icon-ok green"></i>
								...
								<strong class="green">
									...
									Read Mails Updated Successfully !!!
						   ...
						   <div class="alert alert-block alert-error">
							 ...
							 <i class="icon-trash red"></i>
								...
								<strong class="red">
									...
									Read Mails Deleted Successfully !!!
						...
						<div class="alert alert-block alert-success">
							 ...
							 <i class="icon-ok green"></i>
								...
								<strong class="green">
									...
									Read Mails Unblocked Successfully !!!
						   ...
						   <div class="alert alert-block alert-error">
							 ...
							 <i class="icon-off red"></i>
								...
								<strong class="red">
									...
									Read Mails blocked Successfully !!!
                          ...
                          <form action="" method="post">
							...
							<div class="row-fluid">
								...
								<table class="table table-striped table-bordered table-hover" id="sample-table-2">
									...
									<?php 
									$inbdb=$db->get_all("select * from mlm_outbox where (outbox_toprofileid='Admin' and outbox_fromstatus='0') and outbox_readstatus='1' order by outbox_id desc");
									$i=1;
									$num=$db->numrows("select * from mlm_outbox where (outbox_toprofileid='Admin' and outbox_fromstatus='0') and outbox_readstatus='1' order by outbox_id desc");
                                   ...
                                   if($row_inbdb['outbox_userid'] != 'admin')	
									...
									?>
										...
										<tr>
                                            ...
                                            <td><?php echo $row_inbdb['outbox_profileid'];//$row_inbdb['outbox_toprofileid']; ?></td>
