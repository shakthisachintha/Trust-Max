...
if (isset($_REQUEST['update2'])) {
	...
	$insert = $db->insertrec("update mlm_register set user_dob='$date'
	user_phone='$phone'
	user_email='$email'
				...
				<div class="row">
					<div class="col-sm-12">
						<ul class="nav nav-pills">
							<li role="presentation"><a href="fullprofile.php" style="font-size: 20px;">
									< Back to profile</a> </li> <li role="presentation"><a href="changepassprofile.php" style="font-size: 20px;">Change Password</a></li>
