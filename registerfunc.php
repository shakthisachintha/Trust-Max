...
if (isset($_REQUEST['registerone'])) {
    ...
    $sponser = $db->singlerec("select * from mlm_register where user_profileid='$sponsorid'");
    $sponsorname = ucwords($sponser['user_fname']." ".$sponser['user_lname']);
    ...
    $userEmail=addslashes($_REQUEST['email']);
    $policy=addslashes($_REQUEST['policy']);
	$amount=addslashes($_REQUEST['ammount']);
	
    $reward=addslashes($_REQUEST['reward_plan']);
    ...
    $subjectGr="Greetings from Trust-Max";
    $msgGr="<table cellpadding='0' cellspacing='0' border='0' bgcolor='#006699' style='border:solid 10px #006699; width:550px;'>
			<tr bgcolor='#006699' height='25'><td><img src=".$logourl." border='0' width='200' height='60' /></td></tr>
			...
			<tr bgcolor='#FFFFFF' height='30'>
				<td valign='top' style='font-family:Arial; font-size:12px; line-height:18px; text-decoration:none; color:#000000; padding-left:20px;'>
					<b> Dear Business Partner $fName $lnmae </b>
				</td>
			</tr>
			<tr bgcolor='#FFFFFF' height='35' font-family:Arial; >
				<td valign='top' style='font-family:Arial; font-size:12px; line-height:18px; text-decoration:none; color:#000000; padding-left:20px;'>
    ...
    $toGr=$userEmail;
    $greetingsGr = $com_obj->commonMail($toGr, $subjectGr, $msgGr);

    $subjectDl="Downline details from Trust-Max";
    $msgDl="<table cellpadding='0' cellspacing='0' border='0' bgcolor='#006699' style='border:solid 10px #006699; width:550px;'>
			<tr bgcolor='#006699' height='25'><td><img src=".$logourl." border='0' width='200' height='60' /></td></tr>
			<tr bgcolor='#FFFFFF'><td>&nbsp;</td></tr>
			<tr bgcolor='#FFFFFF' height='30'>
    ...
    $toDl=$spocmail;
    $cmailDl=$com_obj->commonMaildl($toDl, $subjectDl, $msgDl);
...
if (isset($_REQUEST['registertwo'])) {
    ...
    if ($userid_num>0) {
        echo '<script language="javascript"> window.location="register_two.php?id='.$profileid.'&exists"; </script>';
        exit;
    }
...
color: #000000;'>&copy; Copyright " .date("Y")."&nbsp;"."<a href='$website_url/login.php' style='font-family:Arial; font-size:11px; font-weight:bold; text-decoration:none; color:#FFFFFF;'>".$website_name."</a>."."
    ...
    if ($mail_sts == "scs") {
        ...
        echo '<script language="javascript"> window.location="register_four.php?id=$prooofid"; </script>';
        exit;
    } else {
